...
namespace SitecoreUrlShorter.Feature.UserInterface.Panels
{
    ...
    public class ShowUrlPanel : RibbonPanel
    {
        ...
        public override void Render(HtmlTextWriter output, Ribbon ribbon, Item button, CommandContext context)
        {
            ...
            htmlOutput +=
                $"<div class='verticallyCentered displayFlex'><input type='text' value='{domain}/{shortUrl.Shorthand}' size='27' id='shortUrl' disabled><button class='copyShortUrlButton' onclick=\"return copyToClipboard('shortUrl')\"></button></div>";
