...
namespace SitecoreUrlShorter.Feature.Core.Repositories
{
    public class ShortUrlRepository : IShortUrlRepository
    {
        ...
        {
            var shorthand = _shorthandGenerator.GenerateShorthand(_settingsRepository.GetShorthandLength(), _settingsRepository.GetShorthandPattern());
            ...
            _requestContext.SitecoreService.SaveItem(new SaveOptions {Model = shortUrl, Silent = true});
        }
    }
}